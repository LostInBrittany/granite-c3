 ...
 *
 * This version is to be used with tools not implementing import.meta yet, like Stencil
 * 
 * Typical usage:
 *
 * ```html
...
class GraniteC3 extends GraniteCssInjector(PolymerElement) {
  ...
  static get cssFiles() {
    return [
        { name: 'c3', path: 'node_modules/c3/c3.min.css' }
    ];
  }
    ...
    return {
       ...
       */
       _dependencies: {
        type: Array,
        value: [
          {name: 'd3', url: `/node_modules/d3/d3.min.js`},
          {name: 'c3', url: `/node_modules/c3/c3.min.js`},
        ],
      },
      /**
